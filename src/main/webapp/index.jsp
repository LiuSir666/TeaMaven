					...
					<div class="panel-body">
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input1" max="1"
										min="0" step="0.1" placeholder="形状">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input2" max="1"
										min="0" step="0.1" placeholder="色泽">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input3" max="1"
										min="0" step="0.1" placeholder="净度">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input4" max="1"
										min="0" step="0.1" placeholder="汤色">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input5" max="1"
										min="0" step="0.1" placeholder="香气">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input6" max="1"
										min="0" step="0.1" placeholder="滋味">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="input7" max="1"
										min="0" step="0.1" placeholder="叶底">
								</div>
							</div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- 图表要绘制到这里，设定宽度和高度 -->
						<div id="chart1" style="height: 392px;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
        ...
        function loadRate() {
        	if($("#input1").val() == "" || $("#input2").val() == "" || $("#input3").val() == "" || $("#input4").val() == "" || $("#input5").val() == "" || $("#input6").val() == "" || $("#input7").val() == ""){
            	...
            	$.ajax({
    				type : 'POST',
    				url : 'http://localhost:8888/Tea/addTea',
    				async : true,
