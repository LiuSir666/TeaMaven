...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" id="topTime"></h3>
                    </div>
                    <div class="panel-body">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      <input id="phoneNumber" type="text" class="form-control" placeholder="请输入手机号">
                      <span id="result"></span>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function loadVoteTea(){
			$.ajax({
				type : 'GET',
				url : 'http://localhost:8888/Tea/listVoteTea',
				async : true,
				success : function(data) {
					$("#voteTeaTable").html("");
					 $.each(data.data, function(index, obj){
							$("#voteTeaTable").append("<div class='col-md-3'><div style='background-color:burlywood; padding:10px;margin-top:5px'><img src='img/"+obj.imageUrl+"' class='img-thumbnail'><button class='btn btn-default' type='button' onclick='loadVote("+obj.id+")' style='width:100%; margin-top:10px;'>投票("+obj.poll+")</button></div></div>");
						});
				},
       ...
       function loadVote(id) {
        	$('#loginModal').modal({});
        		...
        		$.ajax({
    				type : 'GET',
    				url : 'http://localhost:8888/Tea/updateTea/'+id,
    				async : true,
    				success : function(data) {
    					loadVoteTea();
    				},
        ...
        function loadRank() {
    		$.ajax({
				type : 'GET',
				url : 'http://localhost:8888/Tea/topEightTea',
				async : true,
				success : function(data) {
					getTime();
            // 指定图表的配置项和数据
